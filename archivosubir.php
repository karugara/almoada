...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Intranet Tera <small>Archivos excel y otros</small></h1>
...
<div class="">
  <p>
    sube tus archivos arrastrandolos a este lugar.
  </p>
  ...
  <form action="subir.php" class="dropzone" id="dropzone" >
    ...
    Dropzone.options.dropzone = {
    			maxFilesize: 4,
    			acceptedFiles : "image/*,.doc,.pdf,audio,.docx,.xlsx,.xls,.pptx,.txt"
    		};
